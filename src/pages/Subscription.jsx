...
const freePlanFeatures = [
  "Invoicing and Quotes (limited, with watermark)",
  "CRM (up to 5 clients)",
...
const Subscription = () => {
        ...
        const formattedPlans = data
          .map((plan) => {
            ...
            if (plan.name === "Free") fullFeatures = freePlanFeatures;
              ...
              fullFeatures = businessPlanFeatures;
  ...
  const handleSelectPlan = (plan) => {
    if (!user) {
      toast({
        variant: "destructive",
        title: "Error",
        description: "You must be logged in to choose a plan.",
      });
      return;
    }
    ...
    if (!paymentLink) {
      if (plan.name === "Free") {
        toast({
          ...
          description: "You can start using YourBizFlow!",
        });
      ...
      toast({
        ...
        description: `The payment link for this selection is missing.`,
      });
      setIsProcessing(null);
      return;
    }
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-4 bg-background">
      <Helmet>
        <title>Choose your subscription - YourBizFlow</title>
        <meta
          name="description"
          content="Check out YourBizFlow's subscription plans. Choose the plan that best suits your needs and start simplifying your business management."
        />
        <meta
          name="keywords"
          content="subscription, rate, price, YourBizFlow, plan, "
        />
      </Helmet>
      <PlanDetailsDialog
      ...
      >
        ...
        <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
          Start for free, then upgrade your subscription depending on your
          needs.
        </p>
        <div className="flex items-center justify-center gap-4 mt-8">
          <Label
            htmlFor="billing-cycle-sub"
            className={cn(
              "text-muted-foreground",
              billingCycle === "monthly" && "text-foreground font-semibold"
            )}
          >
            Monthly
          </Label>
          <Switch
            id="billing-cycle-sub"
          ...
          <Label
            ...
            className={cn(
              "text-muted-foreground",
              billingCycle === "yearly" && "text-foreground font-semibold"
            )}
          >
            Annual
          </Label>
        ...
        {plans.map((plan, index) => {
          ...
          return (
            <motion.div
              ...
              className={cn(
                "bg-card border rounded-2xl p-8 flex flex-col shadow-lg relative",
                plan.name === "Business" && "border-primary ring-2 ring-primary"
              )}
            >
              {plan.name === "Business" && (
