...
const businessPlanFeatures = [
  ...
  "Module AI Business Strategist",
  "Module RH & Paie",
  "Module Automatisation de Workflow",
    ...
    if (!paymentLink) {
      if (plan.name === "Free") {
        toast({
          ...
          description: "Vous pouvez commencer à utiliser YourBizFlow !",
        });
      ...
      toast({
        ...
        description: `Le lien de paiement pour cette sélection est manquant.`,
      });
      setIsProcessing(null);
      return;
    }
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-4 bg-background">
      <Helmet>
        ...
        <meta
          name="description"
          content="Découvrez les plans d'abonnement de YourBizFlow. Choisissez le plan qui correspond le mieux à vos besoins et commencez à simplifier la gestion de votre entreprise."
        />
        <meta
          name="keywords"
          content="abonnement, tarif, prix, YourBizFlow, plan"
        />
      </Helmet>
      <PlanDetailsDialog
      ...
      >
        ...
        <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
          Commencez gratuitement, puis faites évoluer votre abonnement en
