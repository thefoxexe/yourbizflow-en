...
import { ArrowRight, Users, Contact, History, Filter } from 'lucide-react';
import { cn } from '@/lib/utils';

const AppCRM = () => {
  const color = 'text-green-400';
  const bgColor = 'bg-green-500/10';
  const ringColor = 'ring-green-500/30';
  ...
  const features = [
    {
      ...
      description: "Centralisez toutes les informations : contacts, historique des échanges, factures et projets."
    },
    {
      icon: History,
      title: "Suivi des Interactions",
      description: "Ne perdez jamais le fil d'une conversation. Enregistrez chaque appel, email et rendez-vous."
    },
    {
      icon: Filter,
      title: "Segmentation Facile",
      description: "Triez et filtrez vos clients par tags, statut ou chiffre d'affaires pour des actions ciblées."
    }
  ];

  const pageUrl = "https://yourbizflow.com/apps/crm";
  const title = "CRM | YourBizFlow – Suivi client et gestion des prospects";
  const description = "Centralisez toutes vos informations clients, suivez vos interactions et ne manquez plus jamais une opportunité de vente avec le CRM intégré de YourBizFlow.";
  const imageUrl = "https://images.unsplash.com/photo-1556740758-90de374c12ad?q=80&w=1200";

  const schema = {
    "@context": "https://schema.org",
    "@type": "SoftwareApplication",
    "name": "CRM - YourBizFlow",
  ...
  return (
    <div className="w-full text-white bg-[#030303] overflow-x-hidden">
      <Helmet>
        ...
        <meta name="keywords" content="CRM, gestion client, suivi prospect, logiciel crm, relation client, PME, YourBizFlow" />
      ...
      <main className="pt-24">
        <section className="container mx-auto px-6 py-20 text-center flex flex-col items-center">
          ...
          >
            ...
            <Users className={cn("w-24 h-24", color)} />
          </motion.div>
          ...
          >
            Centralisez vos contacts, suivez chaque interaction et transformez vos prospects en clients fidèles. Le tout, sans quitter YourBizFlow.
          </motion.p>
          <motion.div
          ...
          >
            <Link to="/signup">
              <Button size="lg" className="text-lg px-8 py-6 bg-white text-black hover:bg-white/90 shadow-lg shadow-indigo-500/30">
                Gérer mes clients gratuitement <ArrowRight className="ml-2 w-5 h-5" />
              </Button>
            </Link>
          </motion.div>
        </section>
        ...
        <section className="py-20">
            <div className="container mx-auto px-6 max-w-4xl">
                <div className="relative w-full overflow-hidden rounded-xl border border-white/10 shadow-2xl shadow-green-500/10" style={{ paddingTop: '56.25%' }}>
                    <iframe
                        src="https://www.youtube.com/embed/MR1Qat3DF5Q?si=iS-bZh1_Abd_nKTh"
        ...
        <section className="py-20">
          <div className="container mx-auto px-6 text-center">
             <h2 className="text-3xl md:text-4xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-b from-white to-white/60">Pourquoi choisir le CRM YourBizFlow ?</h2>
             <p className="text-lg text-white/70 max-w-3xl mx-auto">
                Oubliez les CRM usines à gaz. Notre approche est simple : vous donner les outils essentiels pour construire des relations solides avec vos clients, sans la complexité. C'est l'allié parfait pour ne plus jamais laisser passer une opportunité.
             </p>
          </div>
        </section>
