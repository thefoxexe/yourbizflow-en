...
import { ArrowRight, Workflow as WorkflowIcon, Zap, Link2, Bell } from 'lucide-react';
  ...
  const features = [
    {
      ...
      description: "Créez des scénarios basés sur des événements : 'Quand un devis est accepté, alors créer une tâche'."
    },
    {
      icon: Link2,
      title: "Connexion entre Modules",
      description: "Faites communiquer vos modules entre eux pour une fluidité de travail inégalée."
    },
    {
      icon: Bell,
      title: "Notifications Intelligentes",
      description: "Soyez alerté des actions importantes sans être noyé sous les notifications inutiles."
    }
  ];

  const pageUrl = "https://yourbizflow.com/apps/workflow";
  const title = "Automatisation & Workflows | YourBizFlow";
  const description = "Automatisez vos tâches répétitives et créez des flux de travail intelligents. Gagnez du temps et concentrez-vous sur votre croissance avec YourBizFlow.";
  const imageUrl = "https://images.unsplash.com/photo-1551836022-deb4988cc6c0?q=80&w=1200";
  ...
  return (
    <div className="w-full text-white bg-[#030303] overflow-x-hidden">
      <Helmet>
        ...
        <meta name="keywords" content="automatisation, workflow, productivité, automatisation des tâches, PME, YourBizFlow" />
      ...
      <main className="pt-24">
        <section className="container mx-auto px-6 py-20 text-center flex flex-col items-center">
          ...
          >
            Créez des scénarios d'automatisation pour que YourBizFlow travaille pour vous, même quand vous dormez. Libérez-vous des tâches répétitives et concentrez-vous sur la stratégie.
          </motion.p>
          <motion.div
          ...
          >
            <Link to="/signup">
              <Button size="lg" className="text-lg px-8 py-6 bg-white text-black hover:bg-white/90 shadow-lg shadow-indigo-500/30">
                Découvrir l'automatisation <ArrowRight className="ml-2 w-5 h-5" />
              </Button>
            </Link>
          </motion.div>
        </section>
        ...
        <section className="py-20">
          <div className="container mx-auto px-6 text-center">
             <h2 className="text-3xl md:text-4xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-b from-white to-white/60">Pourquoi choisir l'Automatisation ?</h2>
             <p className="text-lg text-white/70 max-w-3xl mx-auto">
                C'est le super-pouvoir des entreprises productives. En automatisant les petites tâches qui vous prennent du temps, vous libérez des heures chaque semaine pour vous concentrer sur l'innovation, la relation client et la croissance.
             </p>
          </div>
        </section>
