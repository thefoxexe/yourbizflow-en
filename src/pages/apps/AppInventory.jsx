...
const AppInventory = () => {
  ...
  const schema = {
    ...
    name: "Purchase/Resale - YourBizFlow",
  ...
  return (
    <div className="w-full text-white bg-[#030303] overflow-x-hidden">
      <Helmet>
        ...
        <meta
          name="keywords"
          content="stock management, inventory, purchase-resale, gross margin, e-commerce, YourBizFlow"
        />
      ...
      <main className="pt-24">
        ...
        <section className="py-20">
          <div className="container mx-auto px-6 max-w-4xl">
            <div
              className="relative w-full overflow-hidden rounded-xl border border-white/10 shadow-2xl shadow-yellow-500/10"
