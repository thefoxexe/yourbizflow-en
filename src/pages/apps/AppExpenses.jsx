  ...
  const features = [
    {
      icon: Camera,
      title: "Scan de Reçus",
      description: "Prenez une photo de votre reçu, et laissez notre IA extraire les informations importantes pour vous."
    },
    {
      icon: PieChart,
      title: "Catégorisation Intelligente",
      description: "Classez vos dépenses (transport, repas, fournitures...) pour une analyse claire de vos coûts."
    },
    {
      icon: Paperclip,
      title: "Lien avec les Projets",
      description: "Associez vos dépenses à des clients ou des projets spécifiques pour un suivi précis de la rentabilité."
    }
  ];

  const pageUrl = "https://yourbizflow.com/apps/expenses";
  const title = "Suivi des Dépenses | YourBizFlow";
  const description = "Enregistrez, catégorisez et analysez toutes vos dépenses professionnelles. Gardez un œil sur vos coûts et optimisez votre rentabilité avec YourBizFlow.";
  const imageUrl = "https://images.unsplash.com/photo-1579621970795-87f91d236086?q=80&w=1200";
  ...
  return (
    <div className="w-full text-white bg-[#030303] overflow-x-hidden">
      <Helmet>
        ...
        <meta name="keywords" content="suivi des dépenses, gestion des coûts, notes de frais, dépenses professionnelles, rentabilité, YourBizFlow" />
      ...
      <main className="pt-24">
        <section className="container mx-auto px-6 py-20 text-center flex flex-col items-center">
          ...
          >
            Photographiez vos reçus, catégorisez vos dépenses et gardez une vue claire sur vos sorties d'argent. La gestion de vos coûts n'a jamais été aussi simple.
          </motion.p>
          <motion.div
        ...
        <section className="py-20">
            <div className="container mx-auto px-6 max-w-4xl">
                <div className="relative w-full overflow-hidden rounded-xl border border-white/10 shadow-2xl shadow-teal-500/10" style={{ paddingTop: '56.25%' }}>
                    <iframe
        ...
        <section className="py-20">
          <div className="container mx-auto px-6 text-center">
             <h2 className="text-3xl md:text-4xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-b from-white to-white/60">Pourquoi choisir le Suivi des Dépenses ?</h2>
             <p className="text-lg text-white/70 max-w-3xl mx-auto">
                Maîtriser ses coûts est la clé de la rentabilité. Ce module transforme une tâche fastidieuse en un processus simple et rapide. Vous obtenez une vision claire de vos dépenses pour mieux piloter votre budget et maximiser vos marges.
             </p>
          </div>
        </section>
