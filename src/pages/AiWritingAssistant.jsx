...
const AiWritingAssistant = () => {
  ...
  const deleteHistoryItem = async (id) => {
    ...
    if (error) {
      ...
      toast({
        title: "Supprimé",
        description: "L'élément a été supprimé de votre historique.",
      });
      fetchHistory();
    }
  };
  ...
  return (
    <div className="container mx-auto p-0 sm:p-4">
      <Helmet>
        ...
        <meta
          name="description"
          content="Générez du contenu professionnel avec l'assistant d'écriture par IA."
        />
      </Helmet>
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              Votre partenaire créatif pour un contenu percutant.
            </p>
          </div>
        </div>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            {suggestions.length === 0 && !isLoading && (
              <div className="flex flex-col items-center justify-center h-full min-h-[300px] text-center p-8 bg-card rounded-lg">
                ...
                <p className="text-muted-foreground">
                  Vos suggestions apparaîtront ici.
                </p>
              </div>
            )}
          </div>
