  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-[#030303]">
      <Helmet>
        ...
        <meta
          name="description"
          content="Connectez-vous à votre compte YourBizFlow pour accéder à votre tableau de bord et gérer votre entreprise."
        />
        <meta name="keywords" content="connexion, login, YourBizFlow, compte" />
      </Helmet>
      <motion.div
